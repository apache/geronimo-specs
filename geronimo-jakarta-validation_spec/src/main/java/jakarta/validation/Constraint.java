 ...
 *         If a constraint gets applied without any specific group then {@link jakarta.validation.groups.Default} is assumed.
 *     </li>
 *     <li>{@code Class<? extends Payload>[] payload() default {};} - Custom {@link Payload} for the contstraint.</li>
 * </ul>
 *
 * @see jakarta.validation.constraints Built in Constraints
 *
 * @version $Rev$ $Date$
 */
@Documented
