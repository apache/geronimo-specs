...
public class Validation {
    ...
    private static class ProviderSpecificBootstrapImpl<T extends Configuration<T>, U extends ValidationProvider<T>>
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.bootstrap.ProviderSpecificBootstrap#ProviderSpecificBootstrap(Class<T>)
         */
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.bootstrap.ProviderSpecificBootstrap#providerResolver(jakarta.validation.ValidationProviderResolver)
         */
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.bootstrap.ProviderSpecificBootstrap#configure()
         */
        public T configure() {
    ...
    private static class GenericBootstrapImpl implements GenericBootstrap, BootstrapState {
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.bootstrap.GenericBootstrap#providerResolver(jakarta.validation.ValidationProviderResolver)
         */
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.spi.BootstrapState#getValidationProviderResolver()
         */
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.spi.BootstrapState#getDefaultValidationProviderResolver()
         */
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.bootstrap.GenericBootstrap#configure()
         */
    ...
    private static class DefaultValidationProviderResolver implements ValidationProviderResolver {
         ...
         * (non-Javadoc)
         *
         * @see jakarta.validation.ValidationProviderResolver#getValidationProviders()
         */
