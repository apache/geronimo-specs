...
{    
    ...
    /**
     * @return {@code true} if there is exactly one {@link jakarta.enterprise.inject.spi.Bean}
     ...
     * This is especially intended for {@link jakarta.enterprise.context.Dependent} scoped beans
