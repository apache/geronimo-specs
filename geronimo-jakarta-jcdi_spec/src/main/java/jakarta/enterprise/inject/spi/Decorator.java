...
public interface Decorator<T> extends Bean<T>
{
     ...
     * class annotated with &#064;{@link jakarta.decorator.Decorator}.
     * @return the decorated types of the decorator.
     */
    Set<Type> getDecoratedTypes();

    /**
     * @return the Type of the &#064;{@link jakarta.decorator.Delegate} injection point.
     */
    Type getDelegateType();

    /**
     * @return the Qualifiers of the &#064;{@link jakarta.decorator.Delegate} injection point.
     */
