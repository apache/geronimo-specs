 ...
 *
 * Normal code shall use {@link jakarta.enterprise.inject.Instance} if possible.
 *
 * The reason for using UnmanagedInstance is for
 * &#064;Dependent scoped instances which should not pollute the
 * {@link jakarta.enterprise.context.spi.CreationalContext} of the containing instance.
 *
...
public class Unmanaged<T>
{
    ...
    /**
     * This basically delegates to the {@link jakarta.enterprise.inject.spi.InjectionTarget}
     * interface
     * @param <T> the type of the CDI instance to create
     */
    public static class UnmanagedInstance<T>
    {
         ...
         * {@link jakarta.enterprise.inject.spi.InjectionTarget#produce(jakarta.enterprise.context.spi.CreationalContext)}
         ...
         * @throws java.lang.IllegalStateException if the instance already got disposed
         * @see jakarta.enterprise.inject.spi.InjectionTarget#inject(Object, jakarta.enterprise.context.spi.CreationalContext)
         */
         ...
         * @see jakarta.enterprise.inject.spi.InjectionTarget#postConstruct(Object)
         */
         ...
         * this method.
         * @see jakarta.enterprise.inject.spi.InjectionTarget#dispose(Object)
         */
