...
public interface BeanManager
{
     ...
     * This takes {@link jakarta.enterprise.util.Nonbinding} into account by ignoring
     * those properties.
     * @param qualifier1
     * @param qualifier2
    ...
    /**
     * @param qualifier
     * @return the hashCode of the Annotation. All {@link jakarta.enterprise.util.Nonbinding} fields get ignored
     */
     ...
     */
    ExpressionFactory wrapExpressionFactory(jakarta.el.ExpressionFactory expressionFactory);
}
