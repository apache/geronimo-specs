...
{
    /**
     * This method can be used to remove and add {@link jakarta.enterprise.inject.Alternative}s,
     * but also to change the sorting order
     * {@link jakarta.enterprise.inject.Alternative}s which are only enabled in a certain
     * BeanArchive are not included in this list.
     * @return the ordered, mutable List of enabled {@link jakarta.enterprise.inject.Alternative}s
     */
