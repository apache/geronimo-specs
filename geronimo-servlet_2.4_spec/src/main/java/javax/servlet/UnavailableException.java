...
public class UnavailableException extends ServletException {
    ...
    /**
     * Does this need an admin action?
     */
    private boolean permanent;
    /**
     * Estimate of how long the resource will be unavaile.
     */
    private int seconds;
     ...
     * the servlet expects to be unavailable; if zero or negative,
     * indicates that the servlet can't make an estimate
     *
     * @param servlet the <code>Servlet</code> that is unavailable
     *
     * @param msg a <code>String</code> specifying the descriptive
     * message, which can be written to a log file or displayed for
     * the user.
     */
     ...
     * the servlet will be temporarily unavailable, or a negative
     * number if the servlet is permanently unavailable or cannot
     * make an estimate
     */
